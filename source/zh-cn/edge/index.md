...
|2|USB-C|USB 3.0,5-[20V](https://www.khadas.com/product-page/usb-c-24w-adapter)的DP输入, 同时可用于[升级系统](https://docs.khadas.com/edge/UpgradeViaUSBCable.html)|
...
|8|Function按键|快速短按3下[进入TST模式](https://docs.khadas.com/edge/HowtoBootIntoUpgradeMode.html)|
|9|Power按键|用于关机或者配合其他按键使用|
|A|314针的金手指|用于与[Captain](https://www.khadas.com/product-page/captain-carrier-board)等扩展板对接|
|B|I-Pex天线|用于连接[wifi](https://docs.khadas.com/edge/HowToConnectWifi.html)和[蓝牙](https://docs.khadas.com/edge/HowToSetupBluetooth.html)的天线|
|C|I-Pex天线|用于连接[wifi](https://docs.khadas.com/edge/HowToConnectWifi.html)和[蓝牙](https://docs.khadas.com/edge/HowToSetupBluetooth.html)的天线|
...
|7|M寄存器|强制板子进入[MaskROM模式](https://docs.khadas.com/edge/HowtoBootIntoUpgradeMode.html)|

## 按键
|Reset|Function|Power|描述说明|
|:---:|:---:|:---:|:---|
|x|||强制重启板子|
||x||[进入TST模式](https://docs.khadas.com/edge/HowtoBootIntoUpgradeMode.html)|
|||x|Power On/Wake Up Edge|
|x||x|[进入升级模式](https://docs.khadas.com/edge/HowtoBootIntoUpgradeMode.html)|
...
|2|RJ-45|有[WOL功能](https://docs.khadas.com/edge/HowtoUseWol.html)的Gigabit网口|
|3|HDMI 2.0|支持4K@60Hz, HDCP 2.2的HDMI接口|
|4||USB-C|USB 3.0,5-[20V](https://www.khadas.com/product-page/usb-c-24w-adapter)的DP输入, 同时可用于[升级系统](https://docs.khadas.com/edge/UpgradeViaUSBCable.html)|
...
|B|[40脚GPIO座子](https://docs.khadas.com/edge/EdgeVGPIOPinout.html)|学习[连接GPIO](https://docs.khadas.com/edge/HowToAccessGpio.html), 或者如何连接[Toneboard](https://www.khadas.com/product-page/tone-board)|
|C|Gesture Sensor|三轴加速传感器|
|D|红外模块|可用于与[khadas遥控器](https://www.khadas.com/product-page/ir-remote)通信|
|E|LED灯|可用于指示LED灯的状态|
|F|I-Pex天线|用于连接[wifi](https://docs.khadas.com/edge/HowToConnectWifi.html)和[蓝牙](https://docs.khadas.com/edge/HowToSetupBluetooth.html)的天线|
|G|I-Pex天线|用于连接[wifi](https://docs.khadas.com/edge/HowToConnectWifi.html)和[蓝牙](https://docs.khadas.com/edge/HowToSetupBluetooth.html)的天线|
...
|3|[SD Card 插座](https://docs.khadas.com/edge/UpgradeViaTFBurningCard.html)|通过SD Card启动或者只作为外部存储器|
...
|7|TP座子|用于连接[TP输入](https://docs.khadas.com/edge/ConnectLcd.html)|
|8|MIPI-TX|MIPI-DSI接口用于连接[LCD显示屏](https://docs.khadas.com/edge/ConnectLcd.html)|
...
|B||M寄存器|强制板子进入[MaskROM模式](https://docs.khadas.com/edge/HowtoBootIntoUpgradeMode.html)|
...
|2|RJ-45|有[WOL功能](https://docs.khadas.com/edge/HowtoUseWol.html)的Gigabit网口|
|3|[40脚GPIO座子](https://docs.khadas.com/edge/CaptainGPIOPinout.html)|学习[连接GPIO](https://docs.khadas.com/edge/HowToAccessGpio.html)
|4|RTC电池座子|硬件时钟芯片供电电池座子|
|5|Reset按键|用于强制重启板子,按下会直接复位|
|6|12V DC 供电座子||替代的[12V直流电源输入](https://www.khadas.com/product-page/captain-12v-adapter.html),请参考[电源优先级](https://docs.khadas.com/edge/EdgeCaptainPowerPriority.html)|
|7|[SD Card 插座](https://docs.khadas.com/edge/UpgradeViaTFBurningCard.html)|通过SD Card启动或者只作为外部存储器|
|8|蜂鸣器|发出简单的声音|
...
|D|USIC|旧版USB总线|
|E|E-DP座子|用于外接eDP显示器|
|F|TP座子|用于连接[TP输入](https://docs.khadas.com/edge/ConnectLcd.html)|
|G|MIPI-TX|MIPI-DSI接口用于连接[LCD显示屏](https://docs.khadas.com/edge/ConnectLcd.html)|
...
|K|Function按键|快速短按3下[进入TST模式](https://docs.khadas.com/edge/HowtoBootIntoUpgradeMode.html)|
|L|麦克风|音频输入|
|M|MXM3连接器|用于连接[Edge](https://www.khadas.com/product-page/edge)|
|N|天线|用于连接[wifi](https://docs.khadas.com/edge/HowToConnectWifi.html)和[蓝牙](https://docs.khadas.com/edge/HowToSetupBluetooth.html)的天线|
|O|天线|用于连接[wifi](https://docs.khadas.com/edge/HowToConnectWifi.html)和[蓝牙](https://docs.khadas.com/edge/HowToSetupBluetooth.html)的天线|
...
||设备名称|描述说明|
|---:|:---|:---|
|1|[M.2 Socket (PCI-E 2.1)](https://docs.khadas.com/edge/ListOfCompatibleNVMeSSDs.html)|可用于连接NVMe SSD|
|2|外部扬声器和DMIC输入FPC连接器|用于连接一个外界的音箱|
|3|[M.2 2280 Stand-Off (M2 Threaded)](https://docs.khadas.com/edge/ListOfCompatibleNVMeSSDs.html)|用于固定SSD|
|4|锂电池座子|可连接便携式[2-Cell Li-Po 电池](https://www.khadas.com/product-page/lipo-battery), 具体可查看[电源优先管理](https://docs.khadas.com/edge/EdgeCaptainPowerPriority.html)|
|5|右按键|自定义可编程按键|
|6|左按键|自定义可编程按键|
...
上述行为是默认的，用户可以更改。例如，可以使白灯闪烁或呼吸。有关如何通过所喜爱的操作系统（每个操作系>统都不同）编程的更多信息可通过[forum.khadas.com](forum.khadas.com)咨询。
...
|4|[USB-C电源接口(5-20V)](https://docs.khadas.com/edge/EdgeCaptainPowerPriority.html)|电源接口|
|5|[USB-C (3.0 + DP)](https://docs.khadas.com/edge/UpgradeViaUSBCable.html)|电源和DP接口|
|6|USB-A|USB 3.0接口|
|7|USB-A|USB 2.0接口|
...
**更多:**
* [Edge+Captain电源优先管理](https://docs.khadas.com/edge/EdgeCaptainPowerPriority.html)
...
**更多:**
* [使用SD卡升级](https://docs.khadas.com/edge/UpgradeViaTFBurningCard.html)
* [从外部介质启动](https://docs.khadas.com/vim2/BootFromExtMedia.html)
* [进入升级模式](https://docs.khadas.com/edge/HowtoBootIntoUpgradeMode.html)
...
**更多:**
* [通过USBC升级系统](https://docs.khadas.com/edge/UpgradeViaUSBCable.html)
* [进入升级模式](https://docs.khadas.com/edge/HowtoBootIntoUpgradeMode.html)

**固件:**
* [Android OS](https://docs.khadas.com/firmware/http://localhost:4000/zh-cn/firmware/EdgeFirmware.html#Ubuntu)
* [Ubuntu OS](https://docs.khadas.com/firmware/http://localhost:4000/zh-cn/firmware/EdgeFirmware.html#android)

# 观看电影，扩展内部eMMC存储
如果您希望将Edge-V或Edge + Captain SBC用作媒体中心，以存储/下载大型电影文件，则这些项目很有用。 microSDXC UHS-I卡价格昂贵，但也足够快以进行4K视频播放。 外部NVMe M.2插槽SSD也足够大，可以容纳整个媒体库。
...
* Edge系列SBC配备了“ Terry的智能镊子”，即使在引导加载程序损坏的情况下，也不需要导电金属镊子即可进行故障恢复。*极端的故障恢复情况将要求您使用MRegister重置Edge SBC。 USB串行调试工具对于开发人员调试复杂的软件问题也很有用。
...
* [如何进入升级模式](https://docs.khadas.com/edge/HowtoBootIntoUpgradeMode.html)

...
Check [Upgrade Via USB Cable Documentation](/android/vim2/UpgradeViaUSBCable.html).
...
Check [Boot From Ext Media Documentation](/android/vim2/BootFromExtMedia.html).
Check [Write SD Image To eMMC](/android/vim2/HowToWriteSDImageToEmmc.html) to write the image to onboard eMMC.
{% endnote %}

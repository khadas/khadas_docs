...
This guide contains step-by-step instructions to create a Burning Card for Linux users. You may also use this Windows Guide([VIM1](/android/vim1/UpgradeViaTFBurningCard.html)/[VIM2](/android/vim2/UpgradeViaTFBurningCard.html)/[VIM3](/vim3/UpgradeViaTFBurningCard.html)) instead.
...
* You may need to format the SD-Card Via FDisk ([VIM1](/android/vim1/CreateBurnCardViaCLI.html)/[VIM2](/android/vim2/CreateBurnCardViaCLI.html)/[VIM3](/vim3/CreateBurnCardViaCLI.html)) if your SD-Card contains >1 partition.
...
2. Follow this guide([VIM1](/android/vim1/HowtoBootIntoUpgradeMode.html)/[VIM2](/android/vim2/HowtoBootIntoUpgradeMode.html)/[VIM3](/vim3/HowtoBootIntoUpgradeMode.html)) to boot into Upgrade Mode.
3. Wait till the process completes.

## Further Reading:
* Booting_Card Vs Burning Card([VIM1](/android/vim1/BootingCardVsBurningCard.html)/[VIM2](/android/vim2/BootingCardVsBurningCard.html)/[VIM3](/vim3/BootingCardVsBurningCard.html))

...
This document describes how to setup, configure and use the KBI. As KBI is one of the [U-Boot](http://www.denx.de) commands, to get started you have to setup a Serial Debugging Tool([VIM2](SetupSerialTool.html)/[VIM3](SetupSerialTool.html)/[Edge](/android/edge/SetupSerialTool.html)).
...
```
## See also
[WOL setup and usage](/android/vim2/Wol.html).

...
var localizedPath = ['vim1', 'vim2', 'edge', 'tone_board', 'firmware'];
...
hexo.extend.helper.register('raw_link', function(path) {
  return 'https://github.com/nicknumb/khadas_docs/edit/master/source/' + path;
});
...
hexo.extend.helper.register('canonical_path_for_nav', function() {
  ...
  if (startsWith(path, 'vim1/') || startsWith(path, 'vim2/') || startsWith(path, 'edge/') || startsWith(path, 'firmware/') || startsWith(path, 'tone_board/')) {
    return path;
  }
  return '';

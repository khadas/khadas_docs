...
We have already explained in the [documentation](/linux/vim3/HowToUseDeviceTreeOverlay.html) how to use Device Tree Overlays.

## Update System

You can refer to this [document](/linux/vim3/HowToUpgradeTheSystem.html).

...
* Reflash the firmware using these [USB Upgrade Instructions](UpgradeViaUSBCable.html), and reboot your Edge.
* If you run into trouble, first press "Switch", then "EraseFlash", then "Upgrade", in that order.

<img src="/linux/images/edge/android_tool_firmware.png" width="50%" height="50%" >

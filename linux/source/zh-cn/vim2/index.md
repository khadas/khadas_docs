...
|2|[SD卡插座](/linux/zh-cn/vim2/BootFromExtMedia.html)|用于从外部介质启动SD卡系统或者作为外部存储器|
|3|500mA保险丝|为USB口提供500mA的电流保护|
|4|WOL选择开关|打开以后可以用WOL的方式唤醒板子|
|5|[MCU](/linux/zh-cn/vim2/KbiGuidance.html)|可编程EEPROM阵列的STM8S003微控制器|
...
**更多：**
[启动卡与烧录卡的比较](/linux/zh-cn/vim2/BootingCardVsBurningCard.html)
[通过TF卡升级安卓](/linux/zh-cn/vim2/UpgradeViaTFBurningCard.html)
[从外部媒体介质启动系统](/linux/zh-cn/vim2/BootFromExtMedia.html)
[如何进入升级模式](/linux/zh-cn/vim2/HowtoBootIntoUpgradeMode.html)
...
**更多：**
* [通过USB升级固件](/linux/zh-cn/vim2/UpgradeViaUSBCable.html)
* [进入升级模式](/linux/zh-cn/vim2/HowtoBootIntoUpgradeMode.html)

**固件**
* [安卓固件](/linux/zh-cn/vim2/FirmwareAndroid.html)
* [Ubuntu固件](/linux/zh-cn/vim2/FirmwareUbuntu.html)
* [LibreELEC](/linux/zh-cn/vim2/FirmwareLibreelec.html)
* [Dual](/linux/zh-cn/vim2/FirmwareDualos.html)
* [U-Boot](/linux/zh-cn/vim2/FirmwareUboot.html)
* [Third Party OSes](/linux/zh-cn/vim2/FirmwareThirdparty.html)
...
如今，大多数人都通过流媒体使用，可以参考[如何安装LibreELEC](/linux/zh-cn/vim2/InstallLibreELEC.html)。
...
**更多:**
* [升级模式](/linux/zh-cn/vim2/HowtoBootIntoUpgradeMode.html)

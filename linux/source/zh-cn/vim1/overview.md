...
|4|USB-C|USB2.0 OTG接口,[5V输出](https://www.khadas.com/product-page/power-adapter),[可用于升级固件](/linux/zh-cn/vim1/UpgradeViaUSBCable.html)|
|5|USB-A|USB 2.0接口,最大输出电流900mA|
|6|风扇座子|PWM控制的4线制风扇|
|7|reset按键|用于强制重启板子,按下会直接复位|
|8|function按键|快速短按3下进入[MaskROM模式](/linux/zh-cn/vim1/HowtoBootIntoUpgradeMode.html)或从外部介质启动|
...
|B|RTC电池接口|硬件时钟电池的接口|
|C|[40脚的GPIO](/linux/zh-cn/vim1/GPIOPinout.html)|可用于控制[GPIO](/linux/zh-cn/vim1/HowToAccessGpio.html)或者与[toneboard](https://www.khadas.com/product-page/tone-board)连接|
|D|红外模块|可用于与[khadas遥控器](https://www.khadas.com/product-page/ir-remote)通信|
|E|LED灯|用于指示板子的状态|
|F|天线座子|用于插[wifi](/linux/zh-cn/vim1/HowToConnectWifi.html)和[蓝牙](/linux/zh-cn/vim1/HowToSetupBluetooth.html)的天线|
</div>
...
|3|M寄存器触点|[强制进入MaskROM模式](/linux/zh-cn/vim1/HowtoBootIntoUpgradeMode.html)|
|4|XPWR焊盘|用于连接使用外部电源|
</div>
...
|:---:|:---:|:---:|:---|
|x|||强制重启VIM1|
||x||[进入升级模式(TST模式)](/linux/zh-cn/vim1/HowtoBootIntoUpgradeMode.html)|
|||x|开机或者唤醒VIM1|
|x||x|[进入升级模式(按键模式)](/linux/zh-cn/vim1/HowtoBootIntoUpgradeMode.html)|
|x|x|x|[清除EMMC](/linux/zh-cn/vim1/HowtoEraseEMMC.html)|
</div>
...
**更多：**
[启动卡与烧录卡的比较](/linux/zh-cn/vim1/BootingCardVsBurningCard.html)
[通过TF卡升级安卓](/linux/zh-cn/vim1/UpgradeViaTFBurningCard.html)
[从外部媒体介质启动系统](/linux/zh-cn/vim1/BootFromExtMedia.html)
[如何进入升级模式](/linux/zh-cn/vim1/HowtoBootIntoUpgradeMode.html)
...
**更多：**
* [通过USB升级固件](/linux/zh-cn/vim1/UpgradeViaUSBCable.html)
* [进入升级模式](/linux/zh-cn/vim1/HowtoBootIntoUpgradeMode.html)

**固件**
* [安卓固件](/linux/zh-cn/vim1/FirmwareAndroid.html)
* [Ubuntu固件](/linux/zh-cn/vim1/FirmwareUbuntu.html)
* [LibreELEC](/linux/zh-cn/vim1/FirmwareLibreelec.html)
* [Dual](/linux/zh-cn/vim1/FirmwareDualos.html)
* [U-Boot](/linux/zh-cn/vim1/FirmwareUboot.html)
* [Third Party OSes](/linux/zh-cn/vim1/FirmwareThirdparty.html)
...
**提示:** 如今，大多数人都通过流媒体使用，可以参考[如何安装LibreELEC](/linux/zh-cn/vim1/InstallLibreELEC.html)
...
**更多:**
* [升级模式](/linux/zh-cn/vim1/HowtoBootIntoUpgradeMode.html)

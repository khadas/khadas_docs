...
The Ubuntu 22.04 Gnome desktop is hardware accelerated with wayland GPU, so you can use SDL2 with GPU by default on desktop.
...
Run OpenGL ES2 Cube Demo.

```sh
khadas@Khadas:/tmp/SDL/test$ export SDL_VIDEODRIVER=wayland
khadas@Khadas:/tmp/SDL/test$ ./testgles2
...
INFO: Version    : OpenGL ES 3.2 v1.r25p1-wayland-drm-g52-r1p0-aarch64-7ff60ff52-1a.8e50ba890d865663aa14f1cd5b301d0f

...
It is backwards-compatible with the DIY Case, vTV Board and Khadas Tone Board, and supports several new ROMs such as [Ubuntu 18.04](/linux/vim2/FirmwareUbuntu.html) and [Google Fuchsia](https://fuchsia.googlesource.com/zircon/+/master/docs/targets/khadas-vim.md).
...
* [Upgrade Using SD-Card](/linux/vim2/UpgradeViaTFBurningCard.html)
* [Boot From External Media](/linux/vim2/BootFromExtMedia.html)
* [Enter Upgrade Mode](/linux/vim2/HowtoBootIntoUpgradeMode.html)
...
**Firmware Images:**
* [Android OS](/linux/vim2/FirmwareAndroid.html)
* [Ubuntu OS](/linux/vim2/FirmwareUbuntu.html)
* [LibreELEC](/linux/vim2/FirmwareLibreelec.html)
* [Dual OS](/linux/vim2/FirmwareDualos.html)
* [U-Boot](/linux/vim2/FirmwareUboot.html)
* [Third Party OSes](/linux/vim2/FirmwareThirdparty.html)
...
Nowadays most people stream their media, see [How To Install LibreELEC](/linux/vim2/InstallLibreELEC.html).
...
**Learn More:**
* [Khadas TST Upgrade Mode](/linux/vim2/HowtoBootIntoUpgradeMode.html#TST-Mode-v1-4-only)
* [MRegister Upgrade Mode](/linux/vim2/HowtoBootIntoUpgradeMode.html)
